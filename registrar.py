...
class Ventana1(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.letrero2.setFixedWidth(830)
        self.letrero2.setText("Por favor ingrese la información del cliente en el formulario de abajo." 
                              "\nLos campos marcados con asterisco son obligatorios.")

        self.letrero2.setFont(QFont("Century", 11))
        ...
        self.botonRegistrar.setStyleSheet("background-color: #00FFFF;"
                                          "color: black;"
                                          "padding: 10px;"
                                          "margin-top: 40px;")
        ...
        self.botonLimpiar.setStyleSheet("background-color: #00FFFF;"
                                        "color: black;"
                                        "padding: 10px;"
                                        "margin-top: 40px;")
        ...
        self.ladoDerecho.setContentsMargins(40, 110, 110, 160)
